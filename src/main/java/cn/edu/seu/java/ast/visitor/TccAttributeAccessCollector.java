...
public class TccAttributeAccessCollector extends ASTVisitor {
  ...
  public TccAttributeAccessCollector(ASTClass exploredClass) {
  ...
  private void initialize() {
    ...
    // extract signatures of all methods in the measured class
    ...
    for (MethodDeclaration md : allMethods) {
      ...
      if (md.getModifiers() == Modifier.PUBLIC) {
        this.allPublicMethods.add(signature);// use signature to avoid "operation overload"
      }
