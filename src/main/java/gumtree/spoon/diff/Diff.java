...
public interface Diff {
  ...
  /**
   * lists all operations (move,insert, deletes). Low-level operation, we recommend using {@link
   * #getRootOperations()}
   */
  ...
  /**
   * returns true if the diff contains a certain operation where the initial node is labeled with
   * nodeLabel
   */
