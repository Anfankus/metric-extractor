 ...
 * <ul>
 * <li>{@link StructureEntityVersion} <code>rootEntity</code> that describes in which attribute,
 * class, or method the
 ...
 * version.</li>
 * <li>{@link Insert}: the entity that was inserted; it is taken from the right AST, i.e., new
 * version.</li>
 * <li>{@link Move}: the entity that was moved; it is taken from the left AST, i.e., old
 * version.</li>
 * <li>{@link Update}: the entity that was updated; it is taken from the left AST, i.e., old
 * version.</li>
 * </ul>
 * </ul>
 * Other entities involved in a source code change are described in the corresponding concrete
 * implementation.
 *
 * @author Beat Fluri
...
public class SourceCodeChange {
   ...
   */
  SourceCodeChange(SourceCodeEntity changedEntity, SourceCodeEntity parentEntity,
      StructureEntityVersion rootEntity, ChangeType changeType) {
  ...
  /**
   * Checks whether the significance level of this change has to be lifted to a higher level or
   * not.
   *
  ...
  public boolean equals(Object obj) {
    ...
    return new EqualsBuilder().append(getChangeType(), other.getChangeType())
        ...
        .append(getParentEntity(), other.getParentEntity())
        .append(getRootEntity(), other.getRootEntity())
        .isEquals();
  }
