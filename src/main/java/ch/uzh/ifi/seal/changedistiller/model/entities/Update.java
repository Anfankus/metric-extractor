 ...
 * updated. Speaking of an AST, <code>parentEntity</code> describes the node in which
 * <code>changedEntity</code> is a child before and after the update. <code>parentEntity</code> is
 * taken from the left AST, i.e., old version. In case
