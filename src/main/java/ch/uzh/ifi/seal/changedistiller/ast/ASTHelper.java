...
/**
 * Handles language specific ASTs and provides access to their content. An AST helper is associated
 * to a file.
 *
 * @param <T> subtype of {@link StructureNode} with which the AST helper works
 * @author Beat Fluri
...
public interface ASTHelper<T extends StructureNode> {
   ...
   *
   * @param node to create the declaration tree
   ...
   *
   * @param node to create the method body tree
   * @return the method body tree for the structure node
   */
  Node createMethodBodyTree(T node);

  /**
   * Converts and returns the type of the AST entity that is associated to the {@link StructureNode}
   * to an {@link EntityType}.
   *
   * @param node to convert its type
   ...
   *
   * @param node to create the source code entity for
   ...
   *
   * @param node to create the structure entity version for
   * @param version the number or id of the version to create
  ...
  /**
   * Creates and returns the {@link StructureEntityVersion} as method of the {@link ClassHistory}.
   * The method is attached to the corresponding {@link MethodHistory}, if exists. Otherwise a new
   * one is created.
   *
   * @param classHistory to create the structure entity version for
  ...
  /**
   * Creates and returns the {@link StructureEntityVersion} as field of the {@link ClassHistory}.
   * The field is attached to the corresponding {@link AttributeHistory}, if exists. Otherwise a new
   * one is created.
   *
   * @param classHistory to create the structure entity version for
   * @param node to create the structure entity version
  ...
  /**
   * Creates and returns the {@link StructureEntityVersion} as class of the {@link ClassHistory}. An
   * inner class version is added to this resulting Inner{@link ClassHistory}.
   *
   * @param classHistory to create the structure entity version for
   * @param node to create the structure entity version
   * @param version the number or id of the version to create
  ...
  /**
   * Creates and returns the declaration {@link Node} tree for the {@link StructureNode}. In
   * addition it replaces the qualified name with the given one.
   *
   * @param node to create the declaration tree
   * @param qualifiedName to use for the tree generation
   * @return the declaration tree for the structure node
   */
