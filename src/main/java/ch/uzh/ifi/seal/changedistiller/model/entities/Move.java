 ...
 * <ul>
 * <li>{@link SourceCodeEntity} <code>oldParentEntity</code> that describes from which entity
 * <code>changedEntity</code>
 * is deleted. Speaking of an AST, <code>parentEntity</code> describes the node in which
 * <code>changedEntity</code> was a child before move. <code>parentEntity</code> is taken from the
 * left AST, i.e., old version.</li>
 * <li>{@link SourceCodeEntity} <code>newParentEntity</code> that describes in which entity
 * <code>changedEntity</code>
 * is inserted. Speaking of an AST, <code>parentEntity</code> describes the node in which
 * <code>changedEntity</code> will be a child after the move. <code>parentEntity</code> is taken
 * from the left AST, i.e., old version. In case
 * <code>parentEntity</code> was inserted (see {@link SourceCodeChange}), it is taken from the right
 * AST.</li>
 * <li>{@link SourceCodeEntity} <code>newEntity</code> that describes which entity
 * <code>changedEntity</code> becomes
...
public class Move extends SourceCodeChange {
   ...
   * @param oldParentEntity the old parent entity
  ...
  public boolean equals(Object obj) {
    ...
    return new EqualsBuilder().appendSuper(super.equals(obj))
        .append(getNewEntity(), other.getNewEntity())
