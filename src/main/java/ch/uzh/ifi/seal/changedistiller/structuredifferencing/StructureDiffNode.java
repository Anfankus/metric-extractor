...
public class StructureDiffNode {
   ...
   * Creates a new structure diff node.
   *
   * @param left part of the diff
   * @param right part of the diff
   */
   ...
   *
   * @return <code>true</code> if the diff node is related to a class or interface,
   ...
   *
   * @return <code>true</code> if the diff node is related to a method or constructor,
   * <code>false</code> otherwise
   */
