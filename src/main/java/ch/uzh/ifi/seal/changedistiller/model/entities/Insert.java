 ...
 * <ul>
 * <li>{@link SourceCodeEntity} <code>parentEntity</code> that describes in which entity
 * <code>changedEntity</code> is
 * inserted. Speaking of an AST, <code>parentEntity</code> describes the node in which
 * <code>changedEntity</code> will be a child after the insert. <code>parentEntity</code> is taken
...
public class Insert extends SourceCodeChange {
   ...
   * @param insertedEntity the inserted entity
   ...
   * @param rootEntity the root entity
   */
  public Insert(StructureEntityVersion rootEntity, SourceCodeEntity insertedEntity,
      SourceCodeEntity parentEntity) {
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder(19, 31).appendSuper(super.hashCode()).append(getParentEntity())
        .toHashCode();
  }
