...
public final class RefactoringExtractor {
   ...
   *
   * <p>
   * For instance, if a method was deleted from a class body and a new one was inserted, this method
   * checks whether the two operations reflect a refactoring.
   *
   * @param addedEntities list of added entities
   * @param deletedEntities list of deleted entities
   * @param refactoringHelper that knows how to deal with a possible refactoring. It corresponds to
   * type of added/deleted entities
