...
/**
 * All types for source code entities that are used by ChangeDistiller to build up the AST.
 *
 * @author zubi
...
public interface EntityType {
  ...
  /**
   * Returns whether or not ChangeDistiller should extract changes occurred on this source code
   * entity type (e.g., changes in the <code>finally</code> clause are ignored).
   *
   * @return <code>true</code> if ChangeDistiller should extract changes on this entity type,
   * <code>false</code>
   * otherwise.
   */
  ...
  /**
   * Returns whether or not the entity type describes a structure entity, e.g., a class, field, or
   * method.
   *
   * @return <code>true</code> if the entity type describes a structure entity, <code>false</code>
   * otherwise
   */
   ...
   *
   * @return <code>true</code> if this entity type is at statement level, <code>false</code>
   * otherwise
   */
