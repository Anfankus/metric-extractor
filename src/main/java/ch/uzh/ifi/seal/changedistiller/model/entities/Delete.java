 ...
 * <ul>
 * <li>{@link SourceCodeEntity} <code>parentEntity</code> that describes from which entity
 * <code>changedEntity</code> is
 * deleted. Speaking of an AST, <code>parentEntity</code> describes the node in which
 * <code>changedEntity</code> was a child before the delete. <code>parentEntity</code> is taken from
 * the left AST, i.e., old version.</li>
 * </ul>
 *
 * @author Beat Fluri
 * @author zubi
...
public class Delete extends SourceCodeChange {
   ...
   * @param rootEntity the root entity
   */
  public Delete(StructureEntityVersion rootEntity, SourceCodeEntity deletedEntity,
      SourceCodeEntity parentEntity) {
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder(17, 31).appendSuper(super.hashCode()).append(getParentEntity())
        .toHashCode();
  }
