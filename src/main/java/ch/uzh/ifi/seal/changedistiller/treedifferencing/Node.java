 ...
 *
 * <p>
 * {@link TreeDifferencer} can only apply the matching and edit script generation if the two trees
 * are made out of such nodes.
 *
 * @author Beat Fluri
 * @see TreeDifferencer
 */
public class Node extends DefaultMutableTreeNode {
   ...
   *
   * @return <code>true</code> if this node is in order with its siblings, <code>false</code>
   * otherwise
   */
   ...
   *
   * @param node to add as associated node
   */
  public void addAssociatedNode(Node node) {
    fAssociatedNodes.add(node);
    this.fEntity.addAssociatedEntity(node.getSourceCodeEntity());
  ...
  public SourceCodeEntity getSourceCodeEntity() {
    return fEntity;
  }

  public void setSourceCodeEntity(SourceCodeEntity entity) {
    fEntity = entity;
  }
   ...
   *
   * @param output to append the node string
...
//    }
   ...
   *
   * @param candidate to check for leaf descendant
   * @return <code>true</code> if the candidate is a leaf and a descendant of this node,
