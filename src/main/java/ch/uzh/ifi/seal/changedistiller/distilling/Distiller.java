...
/**
 * Distills and classifies {@link SourceCodeChange} between two {@link Node} trees. Changes are
 * attached to the {@link StructureEntityVersion} in which the changes happened.
 *
 * @author Beat Fluri
 */
public class Distiller {
  ...
  /**
   * Extracts and classifies {@link SourceCodeChange}s between the left and the right {@link Node}
   * tree. The {@link SourceCodeChange}s are attached to the {@link StructureEntityVersion}.
   *
   * @param leftRoot of the node tree
   * @param rightRoot of the node tree
   */
