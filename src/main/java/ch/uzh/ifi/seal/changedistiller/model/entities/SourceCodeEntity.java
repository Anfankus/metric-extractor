...
public class SourceCodeEntity {
  ...
  /**
   * Constructor to initialize a source code entity with a unique name, a name, a type, and
   * modifiers.
   *
  ...
  public int hashCode() {
    ...
    return new HashCodeBuilder(17, 37).append(getUniqueName()).append(getType())
        .append(getModifiers())
  ...
  public boolean equals(Object obj) {
    ...
    return new EqualsBuilder().append(getUniqueName(), other.getUniqueName())
        ...
        .append(getModifiers(), other.getModifiers())
        .append(getSourceRange(), other.getSourceRange())
        .isEquals();
  }
