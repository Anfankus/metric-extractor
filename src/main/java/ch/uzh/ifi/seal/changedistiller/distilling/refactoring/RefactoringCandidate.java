...
/**
 * A refactoring candidate is a container class that stores a {@link SourceCodeChange} with a {@link
 * StructureDiffNode}.
 *
 * <p>
 * {@link Distiller} decides according to the {@link StructureDiffNode} whether the corresponding
 * {@link SourceCodeChange} may be refactoring candidate. That is, when the change is either a
 * attribute/class/method insert or delete.
 *
 * <p>
 * Concrete refactoring helper use these candidate to find related insert and delete operations of
 * attributes, classes, or methods.
 *
 * @author fluri
 * @see Distiller
...
public final class RefactoringCandidate {
   ...
   *
   * @param sourceCodeChange that may be related to a refactoring
   * @param diffNode that eclipse compare detected
   */
