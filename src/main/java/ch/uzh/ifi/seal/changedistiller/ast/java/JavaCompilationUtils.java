...
public final class JavaCompilationUtils {
  ...
  public static JavaCompilation compile(String source, String fileName) {
    ...
    JavaCompilation javaCompilation = new JavaCompilation(parser.parse(cu, compilationResult),
        parser.scanner);
   ...
   * @param version of Java used in the file
  ...
  private static CompilationResult createDefaultCompilationResult(ICompilationUnit cu,
