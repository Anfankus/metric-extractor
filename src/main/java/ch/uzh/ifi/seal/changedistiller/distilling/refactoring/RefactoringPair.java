...
/**
 * A refacotring pair is a container for storing to {@link RefactoringCandidate}s. Refactoring pairs
 * can be compared according to the similarity between the candidates. This similarity is calculated
 * by the {@link RefactoringExtractor} .
 *
 * <p>
 * Whenever the {@link RefactoringExtractor} decides that two candidates belong to a refactoring, it
 * generates a refactoring pair.
 *
 * @author fluri
...
public class RefactoringPair implements Comparable<RefactoringPair> {
   ...
   *
   * @param deletedEntity entity that was deleted
   * @param insertedEntity entity that was inserted
   * @param similarity between the two candidates
   */
  public RefactoringPair(RefactoringCandidate deletedEntity, RefactoringCandidate insertedEntity,
      double similarity) {
