...
/**
 * Class histories store change data about the history of a class. It contains its attribute, inner
 * classe, and method histories. Top most element for histories.
 * <p>
 * Label:
 *
 * <pre>
...
public class ClassHistory extends AbstractHistory {
  ...
  /**
   * {@link Map} of all method histories belonging to this class history. Key is the unique name of
   * method history.
   */
  private Map<String, MethodHistory> fMethodHistories;

  /**
   * {@link Map} of all attribute histories belonging to this class history. Key is the unique name
   * of attribute history.
   */
  private Map<String, AttributeHistory> fAttributeHistories;

  /**
   * {@link Map} of all inner class histories belonging to this class history. Key is the unique
   * name of inner class history.
   */
   ...
   *
   * @param clazz the clazz to add to this history
   */
  ...
  /**
   * Create an inner class history for the unique name of the given class version if it does not
   * exist. The history is attached to the class history of this history.
   *
   * @param clazz the class version for which a history is to be created
  ...
  /**
   * Returns {@link Map} of attribute histories belonging to this class history. Key is the unique
   * name of attribute history.
   *
  ...
  /**
   * Returns {@link Map} of inner class histories belonging to this class history. Key is the unique
   * name of inner class history.
   *
  ...
  /**
   * Returns {@link Map} of method histories belonging to this class history. Key is the unique name
   * of method history.
   *
   ...
   *
   * @param oldUniqueName name in {@link Map}
   * @param newUniqueName new name in {@link Map}
   */
   ...
   *
   * @param attributeHistories the attribute histories
   */
   ...
   *
   * @param innerClassHistories the inner class histories
   */
   ...
   *
   * @param methodHistories the method histories
   */
  ...
  /**
   * Deletes the provided {@link StructureEntityVersion} from the corresponding {@link
   * MethodHistory}.
   *
   * <p>
   * If the corresponding history has not any versions left, it is also deleted.
   *
   * @param method the structure entity version to delete from the corresponding method history
   */
   ...
   * If the corresponding history has not any versions left, it is also deleted.
   *
   * @param attribute the structure entity version to delete from the corresponding attribute
   * history
   */
