...
public class FieldRefactoringHelper extends AbstractRefactoringHelper {
   ...
   * @param astHelper to help the refactoring helper
   */
  ...
  @Override
  public StructureEntityVersion createStructureEntityVersionWithID(StructureNode node,
      String version) {
  ...
  @Override
  public StructureEntityVersion createStructureEntityVersionWithID(StructureNode node,
      String newEntityName, String version) {
  ...
  public double similarity(StructureNode left, StructureNode right) {
    if (!left.getName().equals(right.getName())) {
      return new LevenshteinSimilarityCalculator()
          .calculateSimilarity(left.getContent(), right.getContent());
    } else {
      return 1.0;
    }
  }
