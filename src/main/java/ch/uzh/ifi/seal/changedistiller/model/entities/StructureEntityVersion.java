...
/**
 * A structure entity version consists of all {@link SourceCodeChange}s applied in a version of an
 * attribute, a class, or a method.
 * <p>
 * For each new version of an attribute, a class, or a method, a new structure entity version is
 * created.
 *
 * @author Beat Fluri
...
public class StructureEntityVersion {
   ...
   *
   * @param type of the structure entity version
   * @param uniqueName of the structure entity version
   * @param modifiers the modifiers
   * @param version the number or id of this version
   */
   ...
   *
   * @param type of this entity
   * @throws RuntimeException if illegal type is passed in
   */
   ...
   *
   * @param sourceCodeChanges the source code changes
   */
   ...
   *
   * @param sourceCodeChange the source code change
   */
