...
/**
 * Interface for all tree matcher. A tree matcher takes two tree (left and right) and finds a match
...
public interface TreeMatcher {
   ...
   *
   * @param leafStringSimilarityCalculator the string similarity calculator for leafs
   * @param leafStringSimilarityThreshold the threshold to verify whether two leafs are similar
   * @param nodeSimilarityCalculator the (inner) node similarity calculator
   * @param nodeSimilarityThreshold the threshold to verify whether two (inner) nodes are similar
   */
  void init(
   ...
   * @param leafStringSimilarityCalculator the string similarity calculator for leafs
   * @param leafStringSimilarityThreshold the threshold to verify whether two leafs are similar
   * @param nodeStringSimilarityCalculator the string similarity calculator for (inner) nodes
   * @param nodeStringSimilarityThreshold the threshold to verify whether two (inner) nodes have
   ...
   *
   * @param left to match with right
   * @param right to match with left
   */
   ...
   *
   * @param matchingSet set in which the matching is stored
   */
   ...
   *
   * @param depth the depth for which dynamic threshold is enabled
   * @param threshold the threshold to use when dynamic threshold is active
   */
