...
public class JavaStructureNode implements StructureNode {
   ...
   * @param qualifier of the node
   * @param name of the node
   * @param astNode representing the structure node
   */
  ...
  /**
   * Returns the fully qualified name of this node if the node has a qualifier. Otherwise, {@link
   * #getName()} is returned.
   *
